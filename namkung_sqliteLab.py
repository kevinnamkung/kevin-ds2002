...
# or conn = sqlite3.connect(r'PATH-TO-YOUR-DIRECTORY/orders.db')   (specifying path of database)
# or conn = sqlite3.connect(:memory:)    (creating in memory)

#cursor object: used to execute queries on database
cur = conn.cursor()
#cur.execute("YOUR-SQL-QUERY-HERE;")  (to execute queries)
...
cur.execute("INSERT INTO users VALUES(?, ?, ?, ?);", user)  #adds extra parameter user
conn.commit()

more_users = [('00003', 'Peter', 'Parker', 'Male'), ('00004', 'Bruce', 'Wayne', 'male')]
cur.executemany("INSERT INTO users VALUES(?, ?, ?, ?);", more_users) #for a list of more users
conn.commit()
